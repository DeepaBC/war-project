...
import ejava.examples.ejbear6.dmv.client.ApproveApplicationAction;
import ejava.examples.ejbear6.dmv.client.CancelApplicationAction;
import ejava.examples.ejbear6.dmv.client.CreateApplication;
import ejava.examples.ejbear6.dmv.client.CreatePhotoAction;
import ejava.examples.ejbear6.dmv.client.GetApplicationAction;
import ejava.examples.ejbear6.dmv.client.GetResidentIDAction;
import ejava.examples.ejbear6.dmv.client.PayApplicationAction;
import ejava.examples.ejbear6.dmv.client.ProtocolClient;
import ejava.examples.ejbear6.dmv.client.RefundApplicationAction;
import ejava.examples.ejbear6.dmv.client.SetPhotoAction;
import ejava.examples.ejbear6.dmv.client.UpdateResidentIDAction;
import ejava.examples.ejbear6.dmv.dto.DMV;
import ejava.examples.ejbear6.dmv.lic.dto.Application;
import ejava.examples.ejbear6.dmv.lic.dto.ContactInfo;
import ejava.examples.ejbear6.dmv.lic.dto.ContactType;
import ejava.examples.ejbear6.dmv.lic.dto.DrvLicRepresentation;
import ejava.examples.ejbear6.dmv.lic.dto.Person;
import ejava.examples.ejbear6.dmv.lic.dto.Photo;
import ejava.examples.ejbear6.dmv.lic.dto.PhysicalDetails;
import ejava.examples.ejbear6.dmv.lic.dto.ResidentID;
import ejava.examples.ejbear6.dmv.lic.dto.ResidentIDApplication;
import ejava.examples.ejbear6.dmv.lic.dto.PhysicalDetails.EyeColor;
import ejava.examples.ejbear6.dmv.lic.dto.PhysicalDetails.HairColor;
import ejava.examples.ejbear6.dmv.lic.dto.PhysicalDetails.Sex;
...
public class ResidentIDProcessTest {
    ...
    public void testBadPayApplication() {
        ...
        CreateApplication createApp = dmv.getAction(CreateApplication.class, dmvResource);
        Application app = createApp.createApplication(resapp);
        assertEquals("unexpected status", Response.Status.CREATED.getStatusCode(), 
                createApp.getStatus());
        ApproveApplicationAction approval = dmv.getAction(ApproveApplicationAction.class, app);
