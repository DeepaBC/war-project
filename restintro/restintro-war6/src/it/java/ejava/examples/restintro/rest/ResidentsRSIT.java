...
public class ResidentsRSIT extends ResidenceServiceTest {    
    ...
    public void testCacheHTTP() {
        ...
        Resident r=proxy.createResident(new Resident("john", "doe"));
        for (int i=0; i<5; i++) {
        ...
        Resident r2=proxy.createResident(new Resident("john2", "doe2"));
        for (int i=0; i<5; i++) {
