 ...
 * so that it can be communicated with using CRUD-based protocols. No additional
 * headers are added in this example.
 */
...
public class ResidentsRS {
    ...
    public List<Person> getResidents(
        ...
        return new Persons(residents, start, count);
    }
    ...
    public void updateResident(Person resident) {
        if (service.updateResident(resident)!=0) {
