...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:param name="siteHref" select="'http://ejava.info/sites/ejava-ws'"/>
  <xsl:param name="docHref" select="'http://ejava.info/sites/ejava-ws'"/>
  <xsl:param name="siteLinkText" select="'EJava WS Development'"/>
